...
class List {
  constructor(url, container, list = listContext) { //url - корзина или каталог, container - отрисовывает
    this.container = container;
    this.list = list; // словарь для классов 1ч42 мин урок 4
    this.url = url;
    this.goods = [];
    this.allProducts = [];
 ...
 */
addProduct(element){
  this.getJson(`S{API}/addToMasket.json`)
   .then(data => {
     if(data.result === 1){
